...
exports.owner = {
    "names": {
        "short": "Sebastian",
        "long": "Sebastian Włudzik"
    },
    "id": "foxcrush" // ID of bot owner (for secure commands, reports, and alerts)
};

// Bot information
exports.bot = {
    "names": {
        "short": "foxbot", // Will be used as 'nickname' in chat (remove if same as account name)
        "long": "Fox Bot" // Name displayed in profile on bot's Facebook account
    },
    "id": "sebastian.bottinger.52" // Bot's ID (for security purposes in commands)
}

// Location of the bot repo if automatic GitHub webhook deploys are used
// (see server.js for details)
exports.repoPath = "/home/foxbot/foxbot-core/";
